...
module.exports = {
  ...
  description: "Devuelve todods los comandos", //the command description for helpcmd [OPTIONAL]
      ...
      if (args[0] && args[0].length > 0) {
        ...
        if (!cmd) {
          return message.reply({
            embeds: [embed.setColor(ee.wrongcolor).setDescription(`No se encontro información para este comando**${args.toLowerCase()}**`)]
          });
        }
